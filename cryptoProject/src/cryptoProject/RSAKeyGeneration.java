...
public class RSAKeyGeneration
{
	...
	*/
	...
	public void generatePublicPrivateKeys()
	{
		...
		if(phi.subtract(E).compareTo(BigInteger.ZERO)==1); //(p-1)-E > 0  //  1 < E < p-1 
		else {
			E = BigInteger.probablePrime(primeSize/2, r);
	 ...
	 */
	public  String generateKey(BigInteger publicKeyB,BigInteger privateKeyB, BigInteger randomNumberB) throws IOException
	{
		
		File file=new File("C:\\Users\\User\\git\\cryptoProject\\cryptoProject\\src\\cryptoProject\\plainKey.txt");
